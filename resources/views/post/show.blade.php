...
@section('content')
    <main class="blog-post">
        <div class="container">
            ...
            <p class="edica-blog-post-meta" data-aos="fade-up" data-aos-delay="200">{{ $date->format('H:i') }},
                {{ $date->translatedFormat('F') }}
                {{ $date->day }} {{ $date->year }}, комментариев: {{ $post->comments->count() }}</p>
                            ...
                            <div class="row">
                                @foreach ($relatedPosts as $post)
                                    <div class="col-md-4" data-aos="fade-right" data-aos-delay="100">
                                        <img src="{{ asset('storage/' . $post->main_image) }}" alt="post_image"
